...
class FormGameLevel2(Form):
    def __init__(self,name,master_surface,x,y,w,h,color_background,color_border,active):
        ...
        # --- CREATE PALTFORMS ---
        self.plataform_list = []
        self.plataform_list.append(Plataform(x=250,y=480,width=50,height=50,type=0))
        self.plataform_list.append(Plataform(x=300,y=480,width=50,height=50,type=1))
        self.plataform_list.append(Plataform(x=350,y=480,width=50,height=50,type=2))   
        self.plataform_list.append(Plataform(x=580,y=490,width=50,height=50,type=0))
        self.plataform_list.append(Plataform(x=630,y=490,width=50,height=50,type=1))
        self.plataform_list.append(Plataform(x=680,y=490,width=50,height=50,type=2))
        self.plataform_list.append(Plataform(x=810,y=430,width=50,height=50,type=12))
        self.plataform_list.append(Plataform(x=860,y=430,width=50,height=50,type=14))
        self.plataform_list.append(Plataform(x=80,y=380,width=50,height=50,type=12))
        self.plataform_list.append(Plataform(x=130,y=380,width=50,height=50,type=14))

        self.bullet_list = []

        # --- CEATE COINS ---
        self.coins_sprites = pygame.sprite.Group()
        self.coins_sprites.add(Coin("images\caracters\players\cowgirl\heart.png", 50, 155, 650))
        self.coins_sprites.add(Coin("images\caracters\players\cowgirl\heart.png",250, 270, 400))
        self.coins_sprites.add(Coin("images\caracters\players\cowgirl\heart.png",600, 380, 250))
        self.coins_sprites.add(Coin("images\caracters\players\cowgirl\heart.png",770, 360, 300))
